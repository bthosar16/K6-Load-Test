...
export default function () {
  ...
  for(let i=0;i<1;i++)
    { let appNumber=Math.floor(Math.random() * (9999 - 1000 + 1 ) + 1000)
        data["application"]["general"]["applicationNumber"]="FC231212"+ appNumber;
        console.log("Application Number "+data["application"]["general"]["applicationNumber"])
    

  // Using a JSON string as body
  let res = http.post(url, JSON.stringify(data), {
    headers: { 'Content-Type': 'application/json', 'authorization': 'G2B_L1T.1671029036.RS256.ecc80cd3-7f55-4886-86ca-654095f5c982.GuG4R10C-Zb56S8i_VgpXx2a-K52jND2IaIK4g1zxddE54QcZPQAvqqAX-SUofef7CjHIJLo-P9JjQcTm8-_rMTYGkRZdaOwiRKB-tHOrKT4D79hJFPNerdsz3kK4oYzTl9p6ex3Dlusse_5p6pN8081vYap1bW-Pr1myjQqKORK6cIDwC1plmn_Dxv_WyR0G3ExvfTpBf_WsETJ8x4cg44lxrAf8dvKuiGI0SJ6bXf_cABbSw_XpHMeXfvzlelXDnBewrC9nraeTm_bKZ6oI1lAkFT26IT6w1i7YhbemGUKy5N-iTuP77tnHTw1QoUWHT4APtMEdtOPl7025T-eUg'},
  });
}
