...
export default function () {
  let data = {
    ...
    "application": {
      "general": {
        ...
        "applicationNumber": "FC2220086711902121",
  ...
  //for(i=0;i<10;i++)
  //  {
  //      data["application"]["general"]["applicationNumber"]=i;
  //      console.log(data["application"]["general"]["applicationNumber"])
  //      console.log(data["application"]["general"]["licenceID"])
  //  }

  // Using a JSON string as body
  let res = http.post(url,data, {
    headers: { 'Content-Type': 'application/json', 'authorization': 'G2B_L1T.1670233319.RS256.5fce0e2a-7c48-4b81-a7e3-e6634e351a7f.WezlGR_GLK_s1gHz9ghI2n_3hu1TaaQbGiqQSKr3Pe9hLgjaJtg3y3OxSzSuDRY5IoQ4dopa-ozFOgUwQSR01CUAp5W1sfSGqVvPyuVaRRYlvW2d3EZ-OOOYF4SjU8hN4MX9V2o_WkHouEaoAH4ksZa9aEu4PwyeREa2seETw76OxNi9peeH10Mbsu9vX-VJIlN-ZSrGLAtqp20-dZW9Cnq7ueSBKm1CgXJnTGx4MCjpJcM5qnqAgQcQOzf2-b5_HZt56UBmRDg-mRtchMKoneYysa37foyUM843kzMdV48zDr43Y3fEws9F7gHZau1odoAGEbRfRYLgnTsHdroXQQ' },
  });
 console.log(res.status)
  // let res= http.post("https://dummy.restapiexample.com/api/v1/create",	{"name":"test","salary":"123","age":"23"})
  console.log(res.json()); // Bert

  // Using an object as body, the headers will automatically include
  // 'Content-Type: application/x-www-form-urlencoded'.
 // res = http.post(url, data);
 // console.log(res.json().form.operation); // Bert

  // Using a binary array as body. Make sure to open() the file as binary
  // (with the 'b' argument).
 // http.post(url, logoBin, { headers: { 'Content-Type': 'application/json' } });
  ...
  // http.post(url, data.buffer, { headers: { 'Content-Type': 'application/json', 'authorization': 'G2B_L1T.1670231849.RS256.8b0c4488-2d73-4e88-8f2f-36c4c7793fdc.AMPr2WZVHAQw6ygTL1-Y_SmAM4XtMsCrfVbLXREotgHWgvYs2VnrNr6PgrRltMMhKlYPpy52sPLQ6-nGUFh9GgQXrb9Qj6XqyZblZnGNEO9xLRdDgwou9__XEnON_-NsGz9Rw8hKqkLhKdKLx9PABMzDzihjBXoLZXR_zms-u4fu8qhE-GP6cLvJmClKAY6YD8YroRa_kDt8fEPslydxgYf98GIRZ9yUIt0hf-ly_XQ35wd-zJi8QNX5XjahVqx30py0CjZ1BLThpuZm8pH-iO7vCaR7JRJfjRXTaX7-8JJav_uFN25_Ej1d41t2w9oqiy-bliN-B2Ut2DBhreneIw' } });
}